...
sessionStorage.setItem('botaoInstrucao', 'sim');
sessionStorage.setItem('recarregar', 'nao');
...
setInterval(function(){
	if(window.sessionStorage.getItem('botaoInstrucao')=='sim'){
		$(".btn_instrucoes").css({"visibility":"visible"});
	}else if(window.sessionStorage.getItem('botaoInstrucao')=='nao'){
		$(".btn_instrucoes").css({"visibility":"hidden"});
	}
    if(window.sessionStorage.getItem('recarregar')=='sim'){
		window.location.href = "index.html";
	}else if(window.sessionStorage.getItem('recarregar')=='nao'){
